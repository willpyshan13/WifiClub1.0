...
public class ActionSheet extends Fragment implements OnClickListener {
    ...
    private static final String ARG_CANCELABLE_HIDDEN = "cancelable_hidden";
    ...
    private boolean mIsOtherButtonCanClick = true;
    ...
    private void createItems() {
        ...
        btnCancel = new Button(getActivity());
        btnCancel.getPaint().setFakeBoldText(true);
        btnCancel.setTextSize(TypedValue.COMPLEX_UNIT_PX, mAttrs.actionSheetTextSize);
        btnCancel.setId(View.generateViewId());
        btnCancel.setBackground(mAttrs.cancelButtonBackground);
        btnCancel.setText(getCancelButtonTitle());
        btnCancel.setTextColor(mAttrs.cancelButtonTextColor);
        btnCancel.setOnClickListener(this);
        LinearLayout.LayoutParams params = createButtonLayoutParams();
        params.topMargin = mAttrs.cancelButtonMarginTop;

        if (!getCancelHidden()) {
            mPanel.addView(btnCancel, params);
        }
    ...
    private boolean getCancelHidden() {
        return getArguments().getBoolean(ARG_CANCELABLE_HIDDEN, false);
    }
    ...
    public void onClick(View v) {
        ...
        if (mIsOtherButtonCanClick) {
            dismiss();
            if (v.getId() != btnCancel.getId() && v.getId() != mBg.getId()) {
                if (mListener != null) {
            ...
            if (v.getId() == btnCancel.getId()) {
                if (mListener != null) {
                    mListener.onDismissWithCancelButton(this);
                }
            }
        } else {
            if (v.getId() == btnCancel.getId()) {
    ...
    public static class Builder {
        ...
        public Builder setCancelButtonHidden(Boolean isHidden) {
            mCancelButtonHidden = isHidden;
            return this;
        }

        public Builder setIsOtherButtonCanClick(boolean mIsOtherButtonCanClick) {
            this.mIsOtherButtonCanClick = mIsOtherButtonCanClick;
            return this;
        }
        ...
        public Bundle prepareArguments() {
            ...
            bundle.putBoolean(ARG_CANCELABLE_HIDDEN,
                    mCancelButtonHidden);
            return bundle;
        }
        ...
        public ActionSheet show() {
            ...
            actionSheet.mIsOtherButtonCanClick = this.mIsOtherButtonCanClick;
    ...
    public interface ActionSheetListener {
        ...
        void onDismissWithCancelButton(ActionSheet actionSheet);
