...
public class PurchaseHistoryAdapter extends BaseExpandableListAdapter {
    ...
    ArrayList<PurchaseHistoryExpandable> data;
    Context context;
    private String currency;

    public PurchaseHistoryAdapter(Context context, ArrayList<PurchaseHistoryExpandable> data) {
        this.data = data;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            paramsIvIcon.setMargins(0, 0, 60, 0);
