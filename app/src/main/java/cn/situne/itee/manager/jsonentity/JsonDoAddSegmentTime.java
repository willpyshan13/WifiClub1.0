/**
 * Project Name: itee
 * File Name:  JsonDoAddSegmentTime.java
...
/**
 * ClassName:JsonDoAddSegmentTime <br/>
 * Function: To add segment time. <br/>
 * Date: 2015-03-11 <br/>
 *
 * @author liaojian
 * @version 1.0
 * @see
 */
public class JsonDoAddSegmentTime extends BaseJsonObject implements Serializable {

    private Data dataList;

    public JsonDoAddSegmentTime(JSONObject jsonObject) {
        super(jsonObject);
    }
