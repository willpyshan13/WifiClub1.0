/**
 * Project Name: itee
 * File Name:  JsonPurchaseHistoryDetailRecord.java
...
/**
 * ClassName:JsonPurchaseHistoryDetailRecord <br/>
 * Function: To set purchase history detail record. <br/>
 * Date: 2015-03-11 <br/>
 *
 * @author dengjunzeng
 * @version 1.0
 * @see
 */
public class JsonPurchaseHistoryDetailRecord extends BaseJsonObject implements Serializable {

    private DataList dataList;

    public JsonPurchaseHistoryDetailRecord(JSONObject jsonObject) {
        super(jsonObject);
    }
...
//        Log.e("",jsonObj.toString());
        ...
        try {
            ...
            dataList.setMemberName(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_MEMBER_NAME));
            dataList.setBookingNo(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_BOOKING_NO));
            dataList.setSignature(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_SIGNATURE));
            dataList.setSubtotal(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_SUBTOTAL));
            dataList.setTax(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_TAX));
            dataList.setDiscount(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_DISCOUNT));
            dataList.setDeposit(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_DEPOSIT));
            dataList.setTotal(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_TOTAL));
            dataList.setMessage(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_MESSAGE));
            dataList.setEmail(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_EMAIL));
            dataList.setPhone(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_PHONE));
            dataList.setPaymentPattern(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_PAYMENT_PATTERN));
            dataList.setRefundTime(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_REFUND_TIME));
            dataList.setPayTime(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_PAY_TIME));
            dataList.setBalanceAccountMoney(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_BALANCE_ACCOUNT_MONEY));
            dataList.setSumBigVoucher(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_SUM_BIG_VOUCHER));
            dataList.setSumVoucher(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_SUM_VOUCHER));
            dataList.setDepositBnc(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_DEPOSIT_BNC));
            dataList.setPayment(Utils.getStringFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_DEPOSIT_PAYMENT));
            ArrayList<GoodListItem> goodListOne = new ArrayList<>();
            JSONArray jaGoodList = Utils.getArrayFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_GOODS_LIST);

            JSONArray joPricingList = Utils.getArrayFromJsonObjectWithKey(joDataList, JsonKey.SHOPPING_PRICING_LIST);
            ...
            dataList.setGoodsList(goodListOne);
            ...
            dataList.setPricingDataList(pricingDataList);
            ...
            JSONArray jaAaList = Utils.getArrayFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_AA_LIST);
            ...
            dataList.setAaList(aaList);

            ArrayList<PackageListItem> packageList = new ArrayList<>();
            JSONArray jaPackageList = Utils.getArrayFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_PACKAGE_LIST);
            ...
            dataList.setPackageList(packageList);

            ArrayList<RefundListItem> refundList = new ArrayList<>();
            JSONArray jaRefundList = Utils.getArrayFromJsonObjectWithKey(joDataList, JsonKey.PLAYER_PURCHASE_HISTORY_DETAIL_REFUND_LIST);
            ...
            dataList.setRefundList(refundList);
