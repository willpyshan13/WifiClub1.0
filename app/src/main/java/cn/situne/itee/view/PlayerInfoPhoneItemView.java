...
public class PlayerInfoPhoneItemView extends RelativeLayout {
    ...
    private JsonGeneralInfo.PhoneItem phoneItem;
    private Boolean isEdit;
    private Boolean isFirst;
    private PlayerInfoEditFragment.OnDeleteClickListener onDeleteClickListener;

    public PlayerInfoPhoneItemView(Context context) {
        super(context);
    }

    public PlayerInfoPhoneItemView(Context context, Boolean isEdit, JsonGeneralInfo.PhoneItem phoneItem,
    ...
    private void initView() {
        ...
        tvDescribe.setInputType(InputType.TYPE_CLASS_PHONE);
...
//        tvDescribe.setCompoundDrawablesWithIntrinsicBounds(imTelDrawable, null, null, null);
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                onDeleteClickListener.OnPhoneDeleteClick("retDelete", phoneItem);
...
//            tvDescribe.setCompoundDrawablesWithIntrinsicBounds(imTelDrawable, null, null, null);
            ...
            tvTag.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AddressTypePopupWindow menuWindow = new AddressTypePopupWindow(context, onDateSelectClickListener, paramTag, true);
        ...
        tvTag.setEnabled(isEdit);
    }

    private void initData() {
        if (phoneItem != null) {
            tvTag.setText(phoneItem.getTag());
            tvDescribe.setText(phoneItem.getValue());
        }
        //fix by syb.
        ...
        tvDescribe.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                JsonGeneralInfo.PhoneItem phoneItemTemp = (JsonGeneralInfo.PhoneItem) thisLL.getTag();
