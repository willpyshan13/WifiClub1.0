/**
 * Project Name: itee
 * File Name:  SelectYearPopupWindow.java
...
/**
 * ClassName:SelectYearPopupWindow <br/>
 * Function: select year popup window. <br/>
 * Date: 2015-03-10 <br/>
 *
 * @author songyuanbin
 * @version 1.0
...
public class SelectYearPopupWindow extends PopupWindow {
    ...
    public SelectYearPopupWindow(Activity context, View.OnClickListener itemclick,int year) {
        super(context);
        ...
        wheelViewYear.setAdapter(new SelectTimeNumericWheelAdapter(0, 5000));
        ...
        if (year!=0)curYear = year;

        wheelViewYear.setCurrentItem(curYear);
