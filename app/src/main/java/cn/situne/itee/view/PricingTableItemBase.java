...
/**
 * ClassName:PricingTableItemBase <br/>
 * Function: PricingTableItemBase. <br/>
 * Date: 2015-07-21 <br/>
 *
 * @author luochao
 * @version 1.0
...
public class PricingTableItemBase extends PricingTableSwipeLinearLayout {
    ...
    public PricingTableItemBase(Context context, int mRightViewWidth) {
        super(context, mRightViewWidth);
        mContext  = context;
    }
