 ...
 */
public class CustomCalendarGridView extends ViewGroup {
    /**
    ...
    public CustomCalendarGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setDayBackground(int resId) {
        for (int i = 1; i < getChildCount(); i++) {
            ((CustomCalendarRowView) getChildAt(i)).setCellBackground(resId);
        }
    }
    ...
    public void setDayTextColor(int resId) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            ((CustomCalendarRowView) getChildAt(i)).setCellTextColor(colors);
        }
    }
    ...
    public void setHeaderTextColor(int color) {
        ((CustomCalendarRowView) getChildAt(0)).setCellTextColor(color);
    }

    public void setTypeface(Typeface typeface) {
        for (int i = 0; i < getChildCount(); i++) {
            ((CustomCalendarRowView) getChildAt(i)).setTypeface(typeface);
        }
    }
    ...
    public void addView(View child, int index, LayoutParams params) {
        if (getChildCount() == 0) {
            ((CustomCalendarRowView) child).setIsHeaderRow(true);
        }
