...
/**
 * TableRow that draws a divider between each cell. To be used with {@link com.squareup.timessquare.CustomCalendarGridView}.
 */
public class CustomCalendarRowView extends ViewGroup implements View.OnClickListener {
    private boolean isHeaderRow;
    private CustomMonthView.Listener listener;

    public CustomCalendarRowView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setListener(CustomMonthView.Listener listener) {
