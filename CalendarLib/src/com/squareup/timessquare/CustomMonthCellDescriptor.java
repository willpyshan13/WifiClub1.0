...
/**
 * Describes the state of a particular date cell in a {@link CustomMonthView}.
 */
class CustomMonthCellDescriptor {
    ...
    CustomJsonAdvancedSetting.DaySetting daySetting;

    CustomMonthCellDescriptor(Date date, boolean currentMonth, boolean selectable, boolean selected,
