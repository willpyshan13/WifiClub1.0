...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
    ...
    public void setCellTextColor(int resId) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (v instanceof CalendarCellView) {
                ((CalendarCellView) getChildAt(i)).getTextView().setTextColor(resId);
            } else {
    ...
    public void setCellTextColor(ColorStateList colors) {
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            if (v instanceof CalendarCellView) {
                ((CalendarCellView) getChildAt(i)).getTextView().setTextColor(colors);
            } else {
    ...
    public void setTypeface(Typeface typeface) {
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            if (v instanceof CalendarCellView) {
                ((CalendarCellView) getChildAt(i)).getTextView().setTypeface(typeface);
            } else {
