 ...
 * initialized after inflation with {@link #init(Date, Date, List<JsonTeeTimeCalendar.DataList.DateStatus>)} and can be customized with any of the
 * {@link ChooseCalendarPickerView.FluentInitializer} methods returned.  The currently selected date can be retrieved with
 * {@link #getSelectedDate()}.
 */
@SuppressWarnings("UnusedDeclaration")
public class ChooseCalendarPickerView extends ListView {

    private final static String FLAG_YES = "1";

    final ChooseMonthView.Listener listener = new CellClickedListener();
    ...
    public void setQuickSelectedClickListener(QuickSelectedClickListener quickSelectedClickListener) {
        this.quickSelectedClickListener = quickSelectedClickListener;
    }

    private QuickSelectedClickListener quickSelectedClickListener;
    ...
    public ChooseCalendarPickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * <p/>
     * This will implicitly set the {@link ChooseCalendarPickerView.SelectionMode} to {@link CalendarPickerView.SelectionMode#SINGLE}.  If you
     * want a different selection mode, use {@link ChooseCalendarPickerView.FluentInitializer#inMode(CalendarPickerView.SelectionMode)} on the
     * {@link ChooseCalendarPickerView.FluentInitializer} this method returns.
     * <p/>
    ...
    public FluentInitializer init(Date minDate, Date maxDate, Locale locale, CustomJsonAdvancedSetting dateStatuses, int firstDayOfWeek) {
        ...
        while ((monthCounter.get(MONTH) <= maxMonth // Up to, including the month.
            ...
            if (dateStatuses.getDataList() != null && dateStatuses.getDataList().size() > 0) {
                month.setMonthDataSourch(dateStatuses.getDataList().get(monthCounter.get(MONTH)));
            }
    ...
    /**
     * Select a new date.  Respects the {@link ChooseCalendarPickerView.SelectionMode} this CalendarPickerView is configured
     * with: if you are in {@link ChooseCalendarPickerView.SelectionMode#SINGLE}, the previously selected date will be
     * un-selected.  In {@link ChooseCalendarPickerView.SelectionMode#MULTIPLE}, the new date will be added to the list of
     * selected dates.
     * <p/>
    ...
    public void clearSelectionsWithMonth(int month) {
...
//                        lastSetting = currentSetting;
     ...
     * <p/>
     * Important: set this before you call {@link #init(Date, Date, List<JsonTeeTimeCalendar.DataList.DateStatus>)} methods.  If called afterwards,
     ...
     *
     * @see #setOnDateSelectedListener(ChooseCalendarPickerView.OnDateSelectedListener)
     */
     ...
     * listener will not be notified.
     *
     * @see #setOnInvalidDateSelectedListener(ChooseCalendarPickerView.OnInvalidDateSelectedListener)
     */
     ...
     *
     * @see #setDateSelectableFilter(ChooseCalendarPickerView.DateSelectableFilter)
     */
     ...
     *
     * @see #setCellClickInterceptor(ChooseCalendarPickerView.CellClickInterceptor)
     */
    ...
    public interface QuickSelectedClickListener {

        void onQuickSelect(Date date);
    }
    ...
    public class FluentInitializer {
        /**
         * Override the {@link ChooseCalendarPickerView.SelectionMode} from the default ({@link CalendarPickerView.SelectionMode#SINGLE}).
         */
         ...
         * pass in multiple dates and haven't already called {@link #inMode(ChooseCalendarPickerView.SelectionMode)}.
         */
    ...
    private class CellClickedListener implements ChooseMonthView.Listener {
        @Override
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ChooseMonthView monthView = (ChooseMonthView) convertView;
            final CustomMonthDescriptor CustomMonthDescriptor = months.get(position);
            if (monthView == null) {
                monthView =
                        ChooseMonthView.create(parent, inflater, weekdayNameFormat, listener, today, dividerColor,
            ...
            monthView.init(monthClickListener, quickSelectedClickListener, CustomMonthDescriptor, cells.get(position), displayOnly, titleTypeface,
